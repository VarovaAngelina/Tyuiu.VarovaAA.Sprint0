...
using Tyuiu.VarovaAA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.VarovaAA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Вароант #0                                                              *");
            Console.WriteLine("* Выполнила: Варова Ангелина Александровна | ИИПб-23-2                    *");
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("* УСЛОВИЕ:                                                                *");
            Console.WriteLine("* Написать контрольную программу на C#, которая суммирует значение двух   *");
